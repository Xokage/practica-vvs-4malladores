...
/**
 * Interfaz Servidor. El token caduca tras devolver 10 contenidos. Se piden dos
 * implementaciones: en una de ellas cada servidor tiene un Servidor de respaldo
 * a quién pregunta en caso de que una búsqueda en local le resulte vacía.
 *
 */
...
public interface Servidor {
	...
	/**
	 * Busca contenido en el servidor. Si se usa un token vacío en las
	 * búsquedas, la lista de contenidos empieza con y tiene un anuncio cada
	 * tres contenidos.
	 * 
	 * @param subcadena
	 *            subcadena por la que buscas el contenido.
	 * @param token
	 *            token para la búsqueda.
