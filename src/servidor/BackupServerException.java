...
public class BackupServerException extends Exception {
	...
	/**
	 * Constante serialVersionUID. Se utiliza para envitar problemas de
	 * serialización.
	 * 
	 * Para más información:
	 * 
	 * @see <a href="URL#value">https://stackoverflow.com/quest

	 *      ions/285793/what-is-a-serialversionuid-and-why-should-i-use-it</a>
	 *
	 */
